...
# libft
## Description
### Implementation of Standart functions from LibC

Libft is the first 42 Schools Project and focuses mainlz on introducing the student to basic C functions via making them gain a deeper understanding of them by having to write them themselves.

Code Syntax follows the 42 Norm.

## The project consists of 3 parts.
* Standard functions from libc
* Additional functions
* Bonus functions mostly focused on lists.

## Instructions
### How to compile:
Using the provided Makefile, the library libft.a can be compiled with the options:

* **make** - to compile all .c files.
* **make clean** to compile all files and remove object files.
* **make fclean** to compile and remove the libft.a file.
* **make re** to recompile the precompiled library.

### How to use:
* Include libft.a in your file.
* Refer to ft_* functions in your code.

#### Use-case of each function:
##### Main part (libc base functions)
...
##### Additional functions (beyond libc)
